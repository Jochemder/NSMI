# ---------------------------------------- File 5_0_1_OSM_greenery_2021 ---------------------------------------- #
# This piece of code imports all modules and libraries that are required for obtaining the greenery surface per neighborhood for 2021 via Open Street Map
import os
import time
import overpy
...
# This piece of code is used to calculate the total area of greenery for each neighborhood in the dataset which contains the geometries and information of all CBS 2021 neighborhoods.
...
if __name__ == '__main__':
    ...
    source_neighborhoods_read.to_file("output/5_0_1_OSM_greenery_2021.gpkg", driver="GPKG")
