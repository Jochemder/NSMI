# ---------------------------------------- File 5_1_1_OSM_water_2019 ---------------------------------------- #
# This piece of code imports all modules and libraries that are required for obtaining the water surface per neighborhood for 2019 via Open Street Map
import os
import time
import overpy
...
# This piece of code is used to calculate the total area of water for each neighborhood in the dataset which contains the geometries and information of all CBS 2019 neighborhoods.
...
if __name__ == '__main__':
    ...
    rel_path = 'intermediate/TEMP_water_2019'
    temp_dir = os.path.join(script_dir, rel_path)

    rel_path = 'water.gpkg'
    out_path = os.path.join(temp_dir, rel_path)

    source_neighborhoods = 'output/5_0_4_OSM_greenery_2019.gpkg'
    ...
    source_neighborhoods_read.to_file("output/5_1_4_OSM_water_2019.gpkg", driver="GPKG")
