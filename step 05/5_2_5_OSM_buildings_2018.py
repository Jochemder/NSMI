# ---------------------------------------- File 5_1_1_OSM_buildings_2018 ---------------------------------------- #
# This piece of code imports all modules and libraries that are required for obtaining the buildings surface per neighborhood for 2018 via Open Street Map
import os
import time
import overpy
...
# This piece of code is used to calculate the total area of buildings for each neighborhood in the dataset which contains the geometries and information of all CBS 2018 neighborhoods.
...
if __name__ == '__main__':
    ...
    source_neighborhoods_read.to_file("output/5_2_5_OSM_buildings_2018.gpkg", driver="GPKG")
