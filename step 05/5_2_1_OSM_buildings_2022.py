# ---------------------------------------- File 5_1_1_OSM_buildings_2022 ---------------------------------------- #
# This piece of code imports all modules and libraries that are required for obtaining the buildings surface per neighborhood for 2022 via Open Street Map
import os
import time
import overpy
...
def downloadXML(BB_Ext, loc_xml):
    api = overpass.API(timeout=120, endpoint=endpoint_overpassAPI, date="2022-12-31T23:59:59Z")
    request = f"""
        (
...
# This piece of code is used to calculate the total area of buildings for each neighborhood in the dataset which contains the geometries and information of all CBS 2022 neighborhoods.
...
if __name__ == '__main__':
    ...
    source_neighborhoods_read.to_file("output/5_2_1_OSM_buildings_2022.gpkg", driver="GPKG")
