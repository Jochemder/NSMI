...
# Define file paths
files = [
    'output/MS_2019/MS_prediction_short.pkl',
    'output/MS_2019/MS_prediction_medium.pkl',
    'output/MS_2019/MS_prediction_long.pkl'
]
...
ax.set_title('NSMI for 2019')
plt.savefig('output/NSMI_2019.png')
print("Plot saved as 'output/NSMI_2019.png'.")
plt.show()