...
# Define file paths
files = [
    'output/MS_2021/MS_prediction_short.pkl',
    'output/MS_2021/MS_prediction_medium.pkl',
    'output/MS_2021/MS_prediction_long.pkl'
]
...
ax.set_title('NSMI for 2021')
plt.savefig('output/NSMI_2021.png')
print("Plot saved as 'output/NSMI_2021.png'.")
plt.show()