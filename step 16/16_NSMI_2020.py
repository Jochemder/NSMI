...
# Define file paths
files = [
    'output/MS_2020/MS_prediction_short.pkl',
    'output/MS_2020/MS_prediction_medium.pkl',
    'output/MS_2020/MS_prediction_long.pkl'
]
...
ax.set_title('NSMI for 2020')
plt.savefig('output/NSMI_2020.png')
print("Plot saved as 'output/NSMI_2020.png'.")
plt.show()