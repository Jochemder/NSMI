...
# Define file paths
files = [
    'output/MS_2018/MS_prediction_short.pkl',
    'output/MS_2018/MS_prediction_medium.pkl',
    'output/MS_2018/MS_prediction_long.pkl'
]
...
ax.set_title('NSMI for 2018')
plt.savefig('output/NSMI_2018.png')
print("Plot saved as 'output/NSMI_2018.png'.")
plt.show()