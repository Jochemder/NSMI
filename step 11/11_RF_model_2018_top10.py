...
data_2018 = pd.read_pickle("output/8_merge_mobility_BE_2018.pkl")
...
top_10_features = [feature for feature in top_10_features if feature in data_2018.columns]

# Select only the top 10 features for X
X = data_2018[top_10_features].values
# Dependent variable remains the same
y = data_2018['Trip_transportation_type'].values
...
with open("output/RF_2018_finalrun_top10/feature_index_mapping.pkl", "wb") as f:
...
print(best_params)
loc_txt = os.path.join(script_dir, 'output/RF_2018_finalrun_top10/best_params.txt')
...
loc_confusion_matrix_absolute = os.path.join(script_dir, 'output/RF_2018_finalrun_top10/confusion_matrix_absolute_2018.png')
loc_confusion_matrix_percentage = os.path.join(script_dir, 'output/RF_2018_finalrun_top10/confusion_matrix_percentage_2018.png')
...
ax_abs.set_title('Confusion Matrix 2018 (Absolute)')
...
ax_pct.set_title('Confusion Matrix 2018 (Percentage)')
...
with open('output/RF_2018_finalrun_top10/random_forest_model.pkl', 'wb') as f:
    pickle.dump(rf, f)

# Save the training and test data to files
with open('output/RF_2018_finalrun_top10/X_train.pkl', 'wb') as f:
    pickle.dump(X_train, f)

with open('output/RF_2018_finalrun_top10/X_test.pkl', 'wb') as f:
    pickle.dump(X_test, f)

with open('output/RF_2018_finalrun_top10/y_train.pkl', 'wb') as f:
    pickle.dump(y_train, f)

with open('output/RF_2018_finalrun_top10/y_test.pkl', 'wb') as f:
