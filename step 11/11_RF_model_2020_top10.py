...
data_2020 = pd.read_pickle("output/8_merge_mobility_BE_2020.pkl")

print('Reading the top 10 features from the text file...')
# Read the top 10 feature names from the text file
with open("output/RF_2020/metrics/top_6_features_2020.txt", "r") as file:
...
top_10_features = [feature for feature in top_10_features if feature in data_2020.columns]

# Select only the top 10 features for X
X = data_2020[top_10_features].values
# Dependent variable remains the same
y = data_2020['Trip_transportation_type'].values
...
with open("output/RF_2020_finalrun_top10/feature_index_mapping.pkl", "wb") as f:
...
print(best_params)
loc_txt = os.path.join(script_dir, 'output/RF_2020_finalrun_top10/best_params.txt')
...
loc_confusion_matrix_absolute = os.path.join(script_dir, 'output/RF_2020_finalrun_top10/confusion_matrix_absolute_2020.png')
loc_confusion_matrix_percentage = os.path.join(script_dir, 'output/RF_2020_finalrun_top10/confusion_matrix_percentage_2020.png')
...
ax_abs.set_title('Confusion Matrix 2020 (Absolute)')
...
ax_pct.set_title('Confusion Matrix 2020 (Percentage)')
...
with open('output/RF_2020_finalrun_top10/random_forest_model.pkl', 'wb') as f:
    pickle.dump(rf, f)

# Save the training and test data to files
with open('output/RF_2020_finalrun_top10/X_train.pkl', 'wb') as f:
    pickle.dump(X_train, f)

with open('output/RF_2020_finalrun_top10/X_test.pkl', 'wb') as f:
    pickle.dump(X_test, f)

with open('output/RF_2020_finalrun_top10/y_train.pkl', 'wb') as f:
    pickle.dump(y_train, f)

with open('output/RF_2020_finalrun_top10/y_test.pkl', 'wb') as f:
