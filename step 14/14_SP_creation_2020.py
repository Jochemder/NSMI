...
synthetic_population_path = 'output/13_prepare_synthetic_population_2020.pkl'
synthetic_population = pd.read_pickle(synthetic_population_path)

# Load the neighborhood dataset
neighborhoods = gpd.read_file('output/7_OMD_pt_2020.gpkg')
...
output_dir = 'output/synthetic_population_2020'
