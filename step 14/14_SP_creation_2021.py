...
synthetic_population_path = 'output/13_prepare_synthetic_population_2021.pkl'
synthetic_population = pd.read_pickle(synthetic_population_path)

# Load the neighborhood dataset
neighborhoods = gpd.read_file('output/7_OMD_pt_2021.gpkg')
...
output_dir = 'output/synthetic_population_2021'
