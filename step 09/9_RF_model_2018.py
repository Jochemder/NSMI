...
X = data_2018.drop(['Trip_transportation_type', 'neighborhoodname'], axis=1).values
...
print(best_params)
loc_txt = os.path.join(script_dir, 'output/RF_2018/best_params.txt')
...
loc_confusion_matrix_absolute = os.path.join(script_dir, 'output/RF_2018/confusion_matrix_absolute_2018.png')
loc_confusion_matrix_percentage = os.path.join(script_dir, 'output/RF_2018/confusion_matrix_percentage_2018.png')
...
with open('output/RF_2018/random_forest_model.pkl', 'wb') as f:
    pickle.dump(rf, f)

# Save the training and test data to files
with open('output/RF_2018/X_train.pkl', 'wb') as f:
    pickle.dump(X_train, f)

with open('output/RF_2018/X_test.pkl', 'wb') as f:
    pickle.dump(X_test, f)

with open('output/RF_2018/y_train.pkl', 'wb') as f:
    pickle.dump(y_train, f)

with open('output/RF_2018/y_test.pkl', 'wb') as f:
