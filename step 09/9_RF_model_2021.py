...
X = data_2021.drop(['Trip_transportation_type', 'neighborhoodname'], axis=1).values
...
print(best_params)
loc_txt = os.path.join(script_dir, 'output/RF_2021/best_params.txt')
...
loc_confusion_matrix_absolute = os.path.join(script_dir, 'output/RF_2021/confusion_matrix_absolute_2021.png')
loc_confusion_matrix_percentage = os.path.join(script_dir, 'output/RF_2021/confusion_matrix_percentage_2021.png')
...
with open('output/RF_2021/random_forest_model.pkl', 'wb') as f:
    pickle.dump(rf, f)

# Save the training and test data to files
with open('output/RF_2021/X_train.pkl', 'wb') as f:
    pickle.dump(X_train, f)

with open('output/RF_2021/X_test.pkl', 'wb') as f:
    pickle.dump(X_test, f)

with open('output/RF_2021/y_train.pkl', 'wb') as f:
    pickle.dump(y_train, f)

with open('output/RF_2021/y_test.pkl', 'wb') as f:
